...
- [6] [Cremer et al., Inference Suboptimality in Variational Autoencoders, ICML, 2018](https://arxiv.org/pdf/1801.03558.pdf)
- [7] [Yoon Kim et al., Semi-Amortized Variational Autoencoders, ICML, 2018](https://arxiv.org/pdf/1802.02550.pdf)
- [8] [Yan et al., Re-balancing Variational Autoencoder Loss for Molecule Sequence Generation, ArXiv, 2019](https://arxiv.org/pdf/1910.00698.pdf)
- [9] [Zhao et al., InfoVAE: Balancing Learning and Inference in Variational Autoencoders, AAAI, 2019](https://arxiv.org/pdf/1706.02262.pdf)
- [10] [He et al., LAGGING INFERENCE NETWORKS AND POSTERIOR COLLAPSE IN VARIATIONAL AUTOENCODERS, ICLR, 2019](https://openreview.net/pdf?id=rylDfnCqF7)
- [11] [Bahuleyan et al., Variational Attention for Sequence-to-Sequence Models, ICCL, 2018](https://arxiv.org/pdf/1712.08207.pdf)
